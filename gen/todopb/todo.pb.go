...
const file_proto_todo_proto_rawDesc = "" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted2\xf0\x01\n" +
	"\vTodoService\x12+\n" +
	"\aAddTodo\x12\x14.todo.AddTodoRequest\x1a\n" +
	".todo.Todo\x12<\n" +
	"\tListTodos\x12\x16.todo.ListTodosRequest\x1a\x17.todo.ListTodosResponse\x125\n" +
	"\fCompleteTodo\x12\x19.todo.CompleteTodoRequest\x1a\n" +
	".todo.Todo\x12?\n" +
	"\n" +
	"DeleteTodo\x12\x17.todo.DeleteTodoRequest\x1a\x18.todo.DeleteTodoResponseB\x1dZ\x1btodo-grpc/gen/todopb;todopbb\x06proto3"
...
var file_proto_todo_proto_goTypes = []any{
	...
	(*CompleteTodoRequest)(nil), // 4: todo.CompleteTodoRequest
...
var file_proto_todo_proto_depIdxs = []int32{
	...
	4, // 3: todo.TodoService.CompleteTodo:input_type -> todo.CompleteTodoRequest
	5, // 4: todo.TodoService.DeleteTodo:input_type -> todo.DeleteTodoRequest
	0, // 5: todo.TodoService.AddTodo:output_type -> todo.Todo
	3, // 6: todo.TodoService.ListTodos:output_type -> todo.ListTodosResponse
	0, // 7: todo.TodoService.CompleteTodo:output_type -> todo.Todo
